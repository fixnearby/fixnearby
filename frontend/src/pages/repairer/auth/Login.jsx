        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          <div className="space-y-6">
            ...
            <div className="flex justify-end">
              <a
                href="/repairer/forgot-password"
                className="text-sm text-emerald-600 hover:text-lime-600 font-medium transition-colors"
              >
                {" "}
                {/* Theme change, corrected path */}
          ...
          <div className="text-center space-y-4">
            <p className="text-gray-600 text-sm">Looking for any services?</p>
            <Link
              to="/user/login"
