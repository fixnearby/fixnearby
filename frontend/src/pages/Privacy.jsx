          ...
          <div className="bg-emerald-50 p-4 rounded-lg">
            ...
            <ul className="space-y-2 text-emerald-800">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Mobile Number:</strong> Required for account creation
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 mt-1 text-emerald-600" />
                <span>
                  <strong>Password:</strong> Securely hashed and encrypted for
                  account protection
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 mt-1 text-emerald-600" />
                <span>
                  <strong>UPI ID:</strong> For repairers only, to facilitate
                  commission payments
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 mt-1 text-emerald-600" />
                <span>
                  <strong>Service Location:</strong> Temporarily collected
          ...
          <div className="bg-red-50 p-4 rounded-lg">
            ...
            <ul className="space-y-2 text-red-800">
              ...
              <li className="flex items-start gap-2">
                <AlertCircle className="w-4 h-4 mt-1 text-red-600" />
                <span>
                  Personal financial information (except UPI for repairers)
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-r from-emerald-500 to-green-600 text-white p-6 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-emerald-100 text-sm">
                  All data transmission uses SSL/TLS encryption protocols
                </p>
              </div>
              <div>
        ...
        <div className="space-y-4">
          <div className="bg-amber-50 border-l-4 border-amber-400 p-4">
            <h4 className="font-semibold text-amber-900 mb-2">
              🗑️ Automatic Deletion Policy
            </h4>
            <p className="text-amber-800">
              Service addresses are automatically deleted once the service is
              completed or cancelled. We don't store your location permanently.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-stone-100 p-4 rounded-lg text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Deleted immediately after service completion
              </p>
            </div>
            <div className="bg-stone-100 p-4 rounded-lg text-center">
            ...
            <div className="bg-stone-100 p-4 rounded-lg text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">
                UPI IDs stored securely for active repairers
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-red-50 border-2 border-red-200 p-4 rounded-lg">
            ...
            <p className="text-red-800">
              FixNearby will never sell, rent, or trade your personal
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-amber-50 p-3 rounded border-l-4 border-amber-400">
                ...
                <p className="text-amber-800 text-sm">
                  Mobile numbers shared between customers and repairers for
          ...
          <div className="bg-gradient-to-r from-emerald-400 to-lime-500 text-white p-6 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-stone-100 bg-opacity-20 backdrop-blur p-3 rounded">
                ...
                <p className="text-sm">
                  Modify your mobile number or other account details
                </p>
              </div>
              <div className="bg-stone-100 bg-opacity-20 backdrop-blur p-3 rounded">
          ...
          <div className="container mx-auto px-6 py-12">
            <div className="text-center">
              ...
              <p className="text-xl text-emerald-100 max-w-2xl mx-auto">
                At FixNearby, your privacy is our priority. We're committed to
                protecting your personal information while connecting you with
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Addresses deleted after service
              </p>
            </div>
            <div className="text-center">
              <div className="bg-emerald-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
        ...
        <div className="mt-8 text-center text-gray-600">
          <p className="text-sm">
            ...
            <span className="ml-2">
              Connecting communities, protecting privacy.
            </span>
          </p>
        </div>
      </div>
