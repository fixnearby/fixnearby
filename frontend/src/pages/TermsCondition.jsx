        ...
        <div className="space-y-4">
          <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-lg">
            ...
            <p className="text-red-800 mb-3 text-sm">
              FixNearby operates solely as a digital platform that connects
              customers with independent repair service providers. We do not
              employ repairers, nor do we provide repair services directly.
            </p>
            <div className="bg-red-100 p-3 rounded">
              ...
              <ul className="space-y-1 text-red-800 text-xs pl-4 list-disc">
                ...
                <li>
                  All repair services are provided by independent third parties
                </li>
                <li>
                  We have no control over repairer behavior or service quality
                </li>
                <li>
                  Your agreement is directly with the repairer, not with us
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="bg-orange-50 p-4 rounded-lg border-2 border-orange-200">
            <h4 className="font-bold text-orange-900 mb-3 flex items-center gap-2">
              <Ban className="w-5 h-5 text-orange-600" /> FixNearby Is NOT
              Responsible For:
            </h4>
          ...
          <div className="bg-red-100 p-4 rounded-lg border border-red-200">
            <h4 className="font-bold text-red-900 mb-2 flex items-center gap-2">
              ⚠️ ZERO WARRANTIES OR GUARANTEES
            </h4>
            <p className="text-red-800 text-sm">
              FixNearby provides NO warranties, guarantees, or assurances
              regarding any repair work performed through our platform. All work
              is performed "AS IS" by independent service providers at your own
              risk.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
            ...
            <p className="text-yellow-800 text-sm">
              By using FixNearby, you acknowledge that any service agreement is
              directly between you and the repairer. FixNearby is not a party to
              this agreement and bears no responsibility for its fulfillment.
            </p>
          </div>
        </div>
      ),
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-red-50 border-2 border-red-200 p-4 rounded-lg">
            ...
            <p className="text-red-800 mb-3 text-sm">
              We reserve the right to immediately suspend or permanently ban
              accounts for the following violations:
            </p>
        ...
        <div className="space-y-4">
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            <h4 className="font-bold text-green-900 mb-3 flex items-center gap-2">
              <CreditCard className="w-5 h-5 text-green-600" /> How Our
              Commission Works
            </h4>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-xs">
                    Commission is calculated automatically when service is
                    marked complete
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-xs">
                    Commission is deducted from total payment before transfer to
                    repairer
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-xs">
                    Remaining amount transferred to repairer's registered UPI ID
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
            <h4 className="font-bold text-red-900 mb-2 flex items-center gap-2">
              ⚠️ Commission Evasion = Account Ban
            </h4>
            <p className="text-red-800 text-sm mb-2">
              Attempting to avoid platform commissions through direct payments
              or other methods will result in immediate account termination.
            </p>
            <div className="bg-red-100 p-2 rounded text-xs text-red-700">
              This includes: exchanging contact info to bypass platform,
              requesting cash payments, or any other method to circumvent our
      ...
      content: (
        <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-red-400">
                ...
                <p className="text-gray-700 text-sm">
                  In no event shall FixNearby's liability exceed the commission
                  amount paid by the repairer for the specific transaction in
                  question. This represents our maximum liability under any
                  circumstances.
                </p>
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-blue-400">
                ...
                <p className="text-gray-700 text-sm">
                  Users agree to indemnify and hold FixNearby harmless from any
                  claims, damages, or expenses arising from their use of our
                  platform or their relationships with other users.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg">
            <h4 className="font-semibold text-yellow-900 mb-2 flex items-center gap-2">
              <Scale className="w-5 h-5 text-yellow-600" /> Governing Law &
              Disputes
            </h4>
            <p className="text-yellow-800 text-sm">
              These terms are governed by Indian law. Any disputes must be
              resolved through binding arbitration in [Your City], India. Users
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            {" "}
            {/* Retained blue for informational */}
            <h4 className="font-semibold text-blue-900 mb-3 flex items-center gap-2">
            ...
            <div className="bg-blue-100 p-3 rounded">
              <p className="text-blue-700 text-xs">
                Major changes will be notified through the app. It's your
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            {" "}
            {/* Changed from purple to gray for neutrality */}
            <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
              <Wrench className="w-5 h-5 text-gray-600" /> Service Modifications
            </h4>
            <p className="text-gray-700 text-sm">
              We reserve the right to modify, suspend, or discontinue any part
              of our service at any time without notice. We are not liable for
              any such modifications or discontinuations.
            </p>
          </div>
        </div>
      ),
        ...
        <div className="bg-green-50 text-gray-900 py-12 px-6 sm:px-8 lg:px-10 rounded-b-3xl shadow-md">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mx-auto mb-6">
              By using FixNearby, you agree to these terms. Please read
              carefully - we're just a connecting platform with limited
              responsibilities.
            </p>
            <div className="bg-red-100 text-red-800 p-3 rounded-lg inline-block border border-red-200">
              <p className="text-sm font-semibold flex items-center gap-2">
                <AlertTriangle className="w-5 h-5 text-red-600" /> CRITICAL: We
                are NOT responsible for repairer actions or service quality
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-6 sm:p-8 mb-8 shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-4 rounded-lg border-l-4 border-red-500 shadow-sm">
              ...
              <p className="text-gray-700 text-sm">
                FixNearby only connects you with repairers. We don't employ
                them, control them, or guarantee their work. All agreements are
                directly between you and the repairer.
              </p>
            </div>
            <div className="bg-white p-4 rounded-lg border-l-4 border-orange-500 shadow-sm">
              ...
              <p className="text-gray-700 text-sm">
                We provide zero warranties on repair work. If something goes
                wrong with the service, you must resolve it directly with the
                repairer - not with us.
              </p>
            </div>
          </div>
        </div>
          ...
          {termsSections.map((section) => (
            <div
              ...
              className={`bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 ${
                section.critical ? "border-2 border-red-200" : ""
              }`}
            >
              <button
                onClick={() => toggleSection(section.id)}
                className={`w-full p-6 text-left flex items-center justify-between hover:bg-gray-50 transition-colors duration-200 ${
                  expandedSection === section.id ? "bg-gray-50" : ""
                } ${section.critical ? "bg-red-50 hover:bg-red-100" : ""}`}
              >
        ...
        <div className="mt-12 bg-gray-50 rounded-xl p-8 shadow-md border border-gray-100">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-3 flex items-center justify-center gap-2">
              <Shield className="w-7 h-7 text-green-600" /> Questions About
              These Terms?
            </h3>
            <p className="text-gray-700 mb-6 text-base max-w-xl mx-auto">
              If you have any questions or require clarifications regarding
              these terms and conditions, please do not hesitate to contact our
              legal team.
            </p>
