  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/user/getotp"
          element={user ? <Navigate to="/user/dashboard" /> : <UserGetotp />}
        />
        <Route
          path="/user/verify-otp"
          element={user ? <Navigate to="/user/dashboard" /> : <UserVerifyotp />}
        />
        <Route
          path="/user/login"
          element={user ? <Navigate to="/user/dashboard" /> : <UserLogin />}
        />
        <Route
          path="/user/signup"
          element={user ? <Navigate to="/user/dashboard" /> : <UserSignup />}
        />

        <Route
          path="/repairer/getotp"
          element={
            repairer ? (
        ...
        <Route
          path="/repairer/login"
          element={
            repairer ? <Navigate to="/repairer/dashboard" /> : <RepairerLogin />
          }
        />
        <Route
          path="/repairer/signup"
          element={
            repairer ? (
              <Navigate to="/repairer/dashboard" />
            ) : (
        ...
        <Route
          path="/user/dashboard"
          element={user ? <UserMaindashboard /> : <Navigate to="/user/login" />}
        />
        <Route
          path="/user/inprogress"
          element={user ? <UserInprogress /> : <Navigate to="/user/login" />}
        />
        <Route
          path="/user/pending-service"
          element={
            user ? <UserPendingservice /> : <Navigate to="/user/login" />
          }
        />
        <Route
          path="/user/show-services"
          element={user ? <Showservices /> : <Navigate to="/user/login" />}
        />
        <Route
          path="/user/messages/:conversationId?"
          element={user ? <UserMessagesPage /> : <Navigate to="/user/login" />}
        />
        <Route
          path="/user/chat/:serviceId"
          element={user ? <UserMessagesPage /> : <Navigate to="/user/login" />}
        />
        <Route
        ...
        />
        <Route
          path="/rejection-fee/:paymentId"
          element={<RejectionPaymentPage />}
        />
        ...
        <Route
          ...
          element={
            repairer ? (
              <RepairerMainDashboard />
            ) : (
              <Navigate to="/repairer/login" />
            )
          }
        />
        <Route
          path="/repairer/settings"
          element={
            repairer ? (
              <RepairerSettingsPage />
            ) : (
              <Navigate to="/repairer/login" />
            )
          }
        ...
        />
        <Route
          path="/repairer/analytics"
          element={
            repairer ? (
              <RepairerAnalyticsPage />
            ) : (
              <Navigate to="/repairer/login" />
            )
          }
        ...
        />
        <Route
          path="/repairer/notifications"
          element={
            repairer ? (
              <RepairerNotificationsPage />
            ) : (
              <Navigate to="/repairer/login" />
            )
          }
        />
        <Route
          path="/repairer/messages/:conversationId?"
          element={
            repairer ? (
              <RepairerMessagesPage />
            ) : (
              <Navigate to="/repairer/login" />
            )
          }
