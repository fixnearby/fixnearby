...
const UserMainDashboard = () => {
  ...
  const getIconForType = (type) => {
    ...
    if (type.toLowerCase().includes("requested"))
      return serviceIcons["Service Requested"];
    if (type.toLowerCase().includes("in progress"))
      return serviceIcons["Service In Progress"];
    if (type.toLowerCase().includes("completed"))
      return serviceIcons["Service Completed"];
    if (type.toLowerCase().includes("cancelled"))
      return serviceIcons["Service Cancelled"];
    if (type.toLowerCase().includes("message")) return serviceIcons["Message"];
    if (type.toLowerCase().includes("account"))
      return serviceIcons["Account Update"];
    return Home;
  };
  ...
  const services = [
    {
      ...
      title: "Appliances",
      description:
        "Repair & maintenance for AC, fridge, washing machine & more.",
      category: "Appliances",
    },
    {
    ...
    },
    {
      ...
      title: "Plumbing",
      description:
        "Leak repair, pipe fitting, drainage issues & bathroom fixes.",
      category: "Plumbing",
    },
    {
      ...
      title: "Carpentry",
      description:
        "Furniture repair, custom woodwork, doors, and window fixes.",
      category: "Carpentry",
    },
    {
    ...
    },
    {
      ...
      title: "Pest Control",
      description:
        "Effective solutions for termites, rodents, cockroaches & more.",
    ...
    },
    {
      ...
      description:
        "Smart locks, CCTV installation, alarm systems & automation.",
    ...
    },
    {
      ...
      description:
        "Garden design, plant care, lawn maintenance & landscape work.",
    ...
    },
    {
      ...
      description:
        "Personalized home styling, space planning & decor solutions.",
      category: "Interior Design",
    },
    {
      image: images.installation,
      title: "Repaires & Installation",
      description:
        "Odd jobs, general household fixes, and small installations.",
    ...
    },
    {
      ...
      description:
        "Accessibility mods, gutter cleaning, septic tank maintenance.",
    ...
    return (
      <div className="min-h-screen bg-[#F9F6F1] py-8 px-4 sm:py-12 sm:px-6 lg:px-8 flex items-center justify-center font-lexend text-[#2C2C2C]">
        <div className="text-center p-6 sm:p-10 bg-white rounded-xl shadow-lg border border-gray-200 animate-fadeInUp">
          <h2 className="text-2xl sm:text-4xl font-extrabold text-[#2C2C2C] mb-3 sm:mb-4">
            Access Denied
          </h2>
          <p className="text-[#2C2C2C] mb-6 sm:mb-8 text-base sm:text-xl leading-relaxed">
            Please log in as a user to unlock your personalized dashboard and
            services.
          </p>
          <Link
            to="/user/login"
            className="px-6 py-3 sm:px-10 sm:py-4 bg-[#8CC76E] text-white font-bold rounded-xl hover:bg-[#72A658] transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1 text-base sm:text-lg"
          >
            Go to Login
          </Link>
        </div>
      ...
      <main className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-10 py-8 sm:py-16">
        <div className="mb-12 sm:mb-20 text-center animate-fadeInUp">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#2C2C2C] mb-3 sm:mb-4 leading-tight">
            Welcome back,{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8CC76E] to-[#72A658]">
              {user?.fullname?.split(" ")[0] || "User"}
            </span>
            !
          </h1>
          <p className="text-[#2C2C2C] max-w-xl sm:max-w-3xl mx-auto font-light text-base sm:text-lg">
            Your one-stop solution for all home services. Let's make your life
            easier.
          </p>
        </div>

        <section className="mb-12 sm:mb-20 animate-fadeInUp delay-100">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#2C2C2C] mb-8 sm:mb-10 text-center">
            Quick Actions
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-2xl sm:max-w-4xl mx-auto">
            ...
            >
              <Rocket
                className="w-12 h-12 mb-3 sm:w-16 sm:h-16 sm:mb-4 text-white transition-transform group-hover:rotate-6 group-hover:scale-110"
                strokeWidth={1.5}
              />
              ...
              <p className="text-white text-sm sm:text-base leading-relaxed opacity-90">
                Quickly book any home repair or maintenance.
              </p>
            </Link>
            <Link
              to="/user/inprogress"
            ...
            >
              <LayoutDashboard
                className="w-12 h-12 mb-3 sm:w-16 sm:h-16 sm:mb-4 text-[#2C2C2C] transition-transform group-hover:-rotate-6 group-hover:scale-110"
                strokeWidth={1.5}
              />
              <h3 className="text-2xl sm:text-3xl font-bold text-[#2C2C2C] mb-1 sm:mb-2">
                View Active Requests
              </h3>
              <p className="text-[#2C2C2C] text-sm sm:text-base leading-relaxed">
                Track the status of your ongoing and pending services.
              </p>
            </Link>
          </div>
        </section>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden h-48 rounded-2xl">
                  ...
                  <div className="absolute inset-0 bg-green-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center"></div>
                </div>
                <h3 className="text-xl sm:text-2xl font-bold text-[#2C2C2C] mb-2 sm:mb-3 mt-3">
                  {service.title}
                </h3>
                <p className="text-[#2C2C2C] text-sm mb-4 sm:mb-6 line-clamp-3 leading-relaxed">
                  {service.description}
                </p>
                ...
                <div className="mt-auto w-full">
                  <button
                    onClick={() => handleServiceClick(service)}
                    className="w-full bg-[#8CC76E] text-white py-2.5 sm:py-3 rounded-xl font-bold text-base sm:text-lg hover:bg-[#72A658] transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-[#8CC76E] focus:ring-offset-2 cursor-pointer"
                  >
                    Book Visit{" "}
                    <span className="ml-2 px-1.5 py-0.5 bg-white text-[#8CC76E] rounded-full text-xs font-bold">
                      FREE
                    </span>
                    <ArrowRight
                      className="ml-1.5 w-4 h-4 sm:ml-2 sm:w-5 sm:h-5 text-white transition-transform group-hover:translate-x-1"
                      strokeWidth={2.5}
                    />
                  </button>
                  <div className="text-xs text-[#2C2C2C] leading-snug mt-2 sm:mt-3 px-1.5 py-0.5 bg-green-50 border border-[#8CC76E] rounded-lg">
                    <strong className="text-red-600">Note:</strong> ₹150
                    cancellation fee applies after technician visit.
                  </div>
                </div>
              </div>
            ))}
        ...
        <section className="mb-12 sm:mb-20 bg-white rounded-xl shadow-md p-6 sm:p-10 lg:p-14 border border-gray-100 animate-fadeInUp delay-300">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#2C2C2C] mb-8 sm:mb-12 text-center">
            Our Simple Process
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-8 sm:gap-y-10 lg:gap-x-8 relative">
            ...
            <div className="flex flex-col items-center text-center p-3 sm:p-4 relative z-10 animate-fadeInUp delay-400">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-[#2C2C2C] mb-1.5 sm:mb-2">
                1. Choose Service
              </h3>
              <p className="text-[#2C2C2C] text-sm leading-relaxed">
                Browse our categories and select the perfect service for your
                needs.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-3 sm:p-4 relative z-10 animate-fadeInUp delay-500">
              ...
              <p className="text-[#2C2C2C] text-sm leading-relaxed">
                Tell us what you need done, when, and where. It's quick & easy.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-3 sm:p-4 relative z-10 animate-fadeInUp delay-600">
              ...
              <p className="text-[#2C2C2C] text-sm leading-relaxed">
                We connect you with highly-rated, local service professionals.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-3 sm:p-4 relative z-10 animate-fadeInUp delay-700">
              ...
              <p className="text-[#2C2C2C] text-sm leading-relaxed">
                Enjoy your restored home. Pay securely after the job is
                complete.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {loadingDashboardData ? (
              ...
              <div className="md:col-span-3 bg-red-100 text-red-700 p-4 sm:p-6 rounded-xl border border-red-200 text-center font-medium shadow-md text-sm sm:text-base">
                <Info className="inline-block w-4 h-4 sm:w-5 sm:h-5 mr-2" />{" "}
              ...
              <>
                <div className="bg-white rounded-xl p-6 sm:p-8 text-[#2C2C2C] flex flex-col items-center justify-center border border-gray-100 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                  <Home
                    className="w-12 h-12 sm:w-14 sm:h-14 text-[#2C2C2C] mb-3 sm:mb-4"
                    strokeWidth={1.5}
                  />
                  <p className="text-[#2C2C2C] text-base sm:text-lg font-medium">
                    Total Services
                  </p>
                ...
                <div className="bg-gradient-to-br from-[#8CC76E] to-[#72A658] rounded-xl p-6 sm:p-8 text-white flex flex-col items-center justify-center hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                  <CheckCircle
                    className="w-12 h-12 sm:w-14 sm:h-14 text-white mb-3 sm:mb-4"
                    strokeWidth={1.5}
                  />
                ...
                <div className="bg-gradient-to-br from-orange-500 to-orange-700 rounded-xl p-6 sm:p-8 text-white flex flex-col items-center justify-center hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                  <Clock
                    className="w-12 h-12 sm:w-14 sm:h-14 text-orange-200 mb-3 sm:mb-4"
                    strokeWidth={1.5}
                  />
          ...
          {loadingDashboardData ? (
            <div className="bg-white p-6 sm:p-10 rounded-xl shadow-md animate-pulse border border-gray-100">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="h-12 sm:h-14 bg-gray-200 rounded-lg mb-3 sm:mb-4 last:mb-0"
                ></div>
              ))}
            </div>
          ) : errorDashboardData ? (
            ...
            <div className="bg-white p-6 sm:p-10 rounded-xl shadow-md text-center text-[#2C2C2C] text-base sm:text-xl border border-gray-100">
              ...
              <p>
                No recent activity to display yet. Let's get some services
                booked!
              </p>
            </div>
          ) : (
              ...
              <ul className="divide-y divide-gray-200">
                {recentUserActivity.map((activity, index) => {
                  ...
                  return (
                    <li
                      key={index}
                      className="flex flex-col sm:flex-row items-start sm:items-center py-3 sm:py-4 first:pt-0 last:pb-0 group hover:bg-gray-50 transition-colors duration-200 rounded-lg px-2 sm:px-3 -mx-2 sm:-mx-3"
                    >
                      <div className="flex items-center mb-1.5 sm:mb-0 sm:mr-6 w-full sm:w-auto">
                        <div className="p-1.5 sm:p-2 bg-[#F9F6F1] rounded-full mr-3 sm:mr-4 shadow-sm group-hover:bg-gray-200 transition-colors">
                          <ActivityIcon
                            className="w-5 h-5 sm:w-6 sm:h-6 text-[#8CC76E]"
                            strokeWidth={2}
                          />
                        </div>
                        <span className="text-[#2C2C2C] font-medium text-base sm:text-lg leading-snug">
                          {activity.message}
                        </span>
                      </div>
                      <span className="ml-auto text-xs sm:text-sm text-[#2C2C2C] mt-0.5 sm:mt-0 whitespace-nowrap">
                        {activity.time}
                      </span>
                    </li>
                  );
