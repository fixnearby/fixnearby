        ...
        <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-green-900 mb-2">Service Operations</h4>
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <h4 className="font-semibold text-purple-900 mb-2">Platform Improvement</h4>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-blue-100 text-sm">All passwords are hashed using industry-standard encryption algorithms before storage</p>
              </div>
              <div>
                <h5 className="font-semibold mb-2">Secure Transmission</h5>
                <p className="text-blue-100 text-sm">All data transmission uses SSL/TLS encryption protocols</p>
              </div>
              <div>
                <h5 className="font-semibold mb-2">Access Control</h5>
                <p className="text-blue-100 text-sm">Strict access controls limit who can view your information</p>
              </div>
              <div>
                <h5 className="font-semibold mb-2">Regular Audits</h5>
                <p className="text-blue-100 text-sm">We conduct regular security audits and updates</p>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-orange-50 border-l-4 border-orange-400 p-4">
            <h4 className="font-semibold text-orange-900 mb-2">🗑️ Automatic Deletion Policy</h4>
            <p className="text-orange-800">Service addresses are automatically deleted once the service is completed or cancelled. We don't store your location permanently.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-yellow-50 p-3 rounded border-l-4 border-yellow-400">
                <h5 className="font-semibold text-yellow-900">Service Fulfillment</h5>
                <p className="text-yellow-800 text-sm">Mobile numbers shared between customers and repairers for service coordination</p>
              </div>
              <div className="bg-blue-50 p-3 rounded border-l-4 border-blue-400">
                <h5 className="font-semibold text-blue-900">Legal Requirements</h5>
                <p className="text-blue-800 text-sm">When required by law enforcement or court orders</p>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-green-400 to-blue-500 text-white p-6 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white bg-opacity-20 backdrop-blur p-3 rounded">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-green-800">Minimal Data</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-blue-800">Secure Storage</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-red-800">Auto-Delete</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-purple-800">No Selling</h3>
        ...
        {/* Contact Section */}
        <div className="mt-12 bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-2xl p-8">
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <div className="bg-white bg-opacity-10 backdrop-blur p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600">privacy@fixnearby.com</p>
              </div>
              <div className="bg-white bg-opacity-10 backdrop-blur p-4 rounded-lg">
                <h3 className="font-semibold mb-2">Support Team</h3>
                <p className="text-sm text-gray-600">Available 24/7 through the app</p>
              </div>
            </div>
          </div>
        </div>
