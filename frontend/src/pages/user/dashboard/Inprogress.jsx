                            ...
                            <div className="p-6">
                                ...
                                <div className="border-t border-gray-200 pt-4 mt-4">
                                    ...
                                    <div className="border-t border-gray-200 pt-4 mt-4">
                                        ...
                                        {request.status === 'quoted' && request.estimatedPrice > 0 ? (
                                            <>
                                            ...
                                            <div className="flex items-center mb-3 text-blue-700">
                                                ...
                                                <span className="font-medium">Awaiting Repairer's Quotation...</span>
                                            </div>
                                        ) : request.status === 'accepted' && request.estimatedPrice > 0 ? (
                                            <div className="flex items-center mb-3 text-green-700">
                                                <CheckCircle className="w-5 h-5 mr-2" />
                                                <span className="font-medium">Quotation Accepted!</span>
                                                <span className="ml-2 text-lg font-bold">₹{request.estimatedPrice}</span>
                                            </div>
                                        ) : request.status === 'rejected' ? (
                                            <div className="flex items-center mb-3 text-red-700">
                                                <XCircle className="w-5 h-5 mr-2" />
                                                <span className="font-medium">Quotation Rejected.</span>
                                                {request.estimatedPrice > 0 && <span className="ml-2 text-gray-600">Original Quote: ₹{request.estimatedPrice}</span>}
                                            </div>
                                        ) : null}
                                    </div>
                                </div>
