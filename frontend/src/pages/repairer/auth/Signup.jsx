...
const Signup = () => {
  ...
  const servicesOffered = servicefromjson.home_services.map(
    (item) => item.main_category
  );
      ...
      <div className="min-h-screen bg-gradient-to-br from-stone-50 via-white to-stone-100 flex items-center justify-center">
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center max-w-md mx-4">
          ...
          <p className="text-gray-600 mb-6">
            You've successfully joined fixNearby. Redirecting to your
            dashboard...
          </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <center className="text-red-600 text-sm">
                      *You can add more services from profile section
                    </center>
                  </div>
                  {errors.services && (
                    <p className="mt-2 text-sm text-red-600">
              ...
              <div className="flex items-start space-x-3">
                ...
                <label htmlFor="agreeToTerms" className="text-sm text-gray-700">
                  ...
                  <Link
                    ...
                    className="text-emerald-600 hover:text-lime-600 font-medium"
                    target="_blank"
                  >
                    Terms of Service
                  </Link>{" "}
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Join thousands of professionals who are building their careers
                on fixNearby.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-green-700 rounded-2xl p-6 text-white">
              ...
              <p className="text-emerald-100 mb-4">
                "fixNearby helped me grow my business by 80% in just 2 months.
                The platform is user-friendly and the support team is amazing!"
              </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Connecting skilled professionals with customers who need quality
                repair services.
              </p>
            </div>
            <div>
